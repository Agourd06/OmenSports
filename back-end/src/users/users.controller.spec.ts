...
describe('UserController', () => {
  ...
  describe('createUser', () => {
    ...
    it('should throw an error if eventId is missing', async () => {
      await expect(controller.createUser('', {  username: 'John Doe',
        email: 'johndoe@example.com',
        phone: '06564646',
        adress: 'jhgsgdh',
        password : '',
  ...
  describe('updateUser', () => {
    it('should update and return the user', async () => {
      const updatedUser = { ...mockUser, username: 'Jane Doe' };
      mockUsersService.updateUser.mockResolvedValue(updatedUser);

      const result = await controller.updateUser('1', { username: 'Jane Doe' });
